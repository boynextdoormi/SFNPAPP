...
public class MD5
{
	...
	{// 闁跨喐鏋婚幏宄邦潗闁跨喐鏋婚幏鐑芥晸閺傘倖瀚归柨鐔活敎閹插瀚归柨鐔告灮閹风兘鏁撻弬銈嗗
		count[0] = 0L;
		count[1] = 0L;
		state[0] = 0x67452301L;
		state[1] = 0xefcdab89L;
	...
	{// 闁跨喐鏋婚幏铚傜秴闁跨喐鏋婚幏鐑芥晸閺傘倖瀚归柨鐔告灮閹风byte0娑撴椽鏁撻弬銈嗗鐟曚線鏁撻弬銈嗗闁跨喐鏋婚幏绋璂5闁跨喐鏋婚幏鐑芥晸閺夋壆顣幏鐑芥晸鐞涙鍤栭幏绌掓稉娲晸鐞涙鍤栭幏鐑芥晸妤楃尨缍囬敓锟�?
	...
	{// 闁跨喐鏋婚幏鐑芥晸缁夋瓕鎻幏鐑芥晸閿燂拷??闁跨喐鏋婚幏鐑芥晸閻偆顣幏鐑芥晸閺傘倖瀚�128娴ｅ秹鏁撻弬銈嗗16闁跨喕顢滈懞鍌︾秶閹风ōD5闁跨喐鏋婚幏鐑芥晸閺傘倖瀚归柨鐔告灮閹风igest闁跨喐鏋婚幏鐑芥晸閺傘倖瀚归柨鐔告灮閿燂拷?
	...
	{// 鏉烆剟鏁撻弬銈嗗闁跨喐鏋婚幏鐑芥晸閺傘倖瀚筧l闁跨喐鏋婚幏绌昽ng闁跨喖鍙洪惃鍕敾閹风兘鏁撻弬銈嗗闁跨喐鏋婚幏鐑芥晸閺傘倖瀚归柨鐔虹yte闁跨喖鍙虹喊澶嬪闁跨喐鏋婚幏鐑芥晸閺傘倖瀚筧byte0闁跨喎褰ㄩ敐蹇斿
		// 闁跨喐鏋婚幏铚傜秴闁跨喕顢滈弬銈嗗闁跨喐鏋婚幏宄板闁跨喐鏋婚幏鐑芥晸閺傘倖瀚规担宥夋晸鐞涙鏋婚幏鐑芥晸閼哄倻灏ㄩ敓锟�?
		int j = 0;
		for (int k = 0; k < i; k += 4)
		{
	...
	private void Decode(long al[], byte abyte0[], int i)
	{
		...
		for (int k = 0; k < i; k += 4)
		{
			al[j] = ByteToLong(abyte0[k]) | ByteToLong(abyte0[k + 1]) << 8 | ByteToLong(abyte0[k + 2]) << 16
					| ByteToLong(abyte0[k + 3]) << 24;
			j++;
		}
	}
	...
	{// 闁跨喕顢滈懞鍌滎暜閹峰嘲宕勯柨鐔告灮閹风兘鏁撻弬銈嗗妫版垿鏁撶槐绐糃II闁跨喐鏋婚幏鐤祮闁跨喐鏋婚敓锟�?
