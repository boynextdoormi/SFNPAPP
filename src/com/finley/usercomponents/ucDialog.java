...
public class ucDialog extends Dialog
{
	...
	public static class Builder
	{
		 ...
		 * @return
		 */
		public Builder setNeutralButton(int negativeButtonText, DialogInterface.OnClickListener listener)
		{
			this.neutralButtonText = (String) context.getText(negativeButtonText);
		...
		public ucDialog create()
		{
			...
			final ucDialog dialog = new ucDialog(context, R.style.CustomDialog);
			View layout = inflater.inflate(R.layout.uc_dialog, (ViewGroup) null);
